	...
	<div class="container h-100">
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" name="su_contact_no" class="form-control input_pass" placeholder="Enrollment no" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="contact_no" class="form-control input_user" placeholder=" Enrollment no" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                ...
                ?>
<font color="white"><center>Made by Pranvi</center></font>
                <?php 
